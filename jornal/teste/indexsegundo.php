...
<div class="container">
  <header class="blog-header lh-1 py-3 mb-4 ">
    ...
    <div class="col-md-6">
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        ...
        <div class="col-auto d-none d-lg-block">
          <img src="<?php echo $titulos['caminho_imagem'] ?>" width="250" height="250" alt="">
    ...
    <div class="col-md-4">
      <div class="position-sticky" style="top: 2rem;">
        <div class="p-4 mb-3 bg-light rounded">
          ...
          <p class="mb-0">optamos por desenvolver um jornal pra dar noticia bla bla bla bla</p>
        </div>
...
<footer class="container">
    <p class="mt-3">&copy; 2022–2023 ETE Antonio Arruda</p>
  </footer>
